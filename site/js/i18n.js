...
(function () {
  ...
  var ADMIN = {
    ug: {
      ...
      act: { add: "قوشۇش", edit: "تەھرىرلەش", del: "ئۆچۈرۈش", save: "ساقلاش", cancel: "بىكار قىلىش", saved: "ساقلاندى", deleted: "ئۆچۈرۈلدى", export: "چىقىرىش", import: "كىرگۈزۈش", reset: "ئەسلىگە قايتۇرۇش", resetConfirm: "بارلىق ئۆزگەرتىشلەر ئۆچۈرۈلۈپ ئەسلى مەزمۇن قايتىدۇ. داۋاملاشتۇرامسىز؟" },
